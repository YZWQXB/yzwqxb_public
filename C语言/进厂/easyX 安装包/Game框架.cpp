...
//--------------优雅的警戒线 以上为雷区 非专业 勿进------------------// 
//TODO: 2 全局变量声明位置 
int x = 200, y = 300, r = 200;
int th;
IMAGE img[4];
//TODO: 3 游戏初始化位置  
 void gameInit()
{
	 loadimage(&img[0], L".\\fox\\0-0.png");
	 loadimage(&img[1], L".\\fox\\0-1.png");
	 loadimage(&img[2], L".\\fox\\0-2.png");
	 loadimage(&img[3], L".\\fox\\0-3.png");
